...
class Car:
    ...
    @classmethod
    def create_calliope(cls, current_date: date, last_service_date: date, current_mileage: int, last_service_mileage: int):
        days_since_last_service = (current_date - last_service_date).days
        miles_since_last_service = current_mileage - last_service_mileage
        miles_until_next_service = 30000 - miles_since_last_service
...
car, miles_until_next_service, days_until_next_service = Car.create_calliope(date(2022, 3, 13), date(2021, 12, 1), 12000, 8000)
