...
class Car:
    ...
    @classmethod
    def create_rorschach(cls, current_date: date, last_service_date: date, current_mileage: int, last_service_mileage: int):
...
car, miles_until_next_service, days_until_next_service = Car.create_rorschach(date(2022, 3, 13), date(2021, 12, 1), 12000, 8000)
